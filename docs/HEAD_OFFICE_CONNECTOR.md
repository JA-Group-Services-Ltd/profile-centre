...
Sousa Murray Profiles connects to the JA Group Services Head Office customer authority
...
before creating a Sousa Murray Profiles session. The returned UCN and branch-safe
...
After a successful customer sign-in, Sousa Murray Profiles sends an authenticated
...
The Head Office UCN is the only customer number shown by Sousa Murray Profiles.
