...
import { requestProfileVerification } from "../../../_shared/profile-interactions.js";
...
export async function onRequest(context) {
  ...
  try {
    ...
    const result = await requestProfileVerification(context.request, context.env.DB, user, profileId, body.note);
