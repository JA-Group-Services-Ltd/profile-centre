...
// ── JA Profile Studio User Number — backfill on startup ────────────────────────
 ...
 * Look up a customer by their JA Profile Studio User Number.
  ...
  try {
    ...
    const exportData = {
      _meta: {
        ...
        note: 'This file contains all personal data held by JA Profile Studio for your account under UK GDPR. Passwords, PINs, session tokens and internal secrets are never included.',
      },
      account: user,
      consent: {
