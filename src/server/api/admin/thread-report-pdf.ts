  ...
  try {
    ...
    function drawChrome(pageIdx: number, total: number) {
      ...
      doc.fillColor(WHITE).fontSize(7).font('Helvetica-Bold')
        .text('SOUSA MURRAY PROFILES — EVIDENCE REPORT', MARGIN, 12, { width: CONTENT_W / 2 });
    ...
    doc.fillColor(GRAY_400).fontSize(9).font('Helvetica-Bold')
      .text('SOUSA MURRAY PROFILES', MARGIN, 84, { characterSpacing: 2 });
    ...
    doc.fillColor(GRAY_600).fontSize(7.5).font('Helvetica')
      .text(
        'This document is an official evidence report generated by the Sousa Murray Profiles platform. ' +
    ...
    doc.fillColor(GRAY_400).fontSize(6.5).font('Helvetica')
      .text(`Sousa Murray Profiles  ·  Evidence Report  ·  ${reportRef}  ·  CONFIDENTIAL`, MARGIN, PAGE_H - 18, { width: CONTENT_W, align: 'center' });
    ...
    doc.fillColor(GRAY_800).fontSize(8.5).font('Helvetica')
      .text(
        ...
        `the Sousa Murray Profiles platform database on ${fmt(generatedAt)}. ` +
