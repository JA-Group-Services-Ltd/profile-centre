...
By accessing or using JA Profile Studio ("the Service"), operated by JA Group Services Ltd ("we", "us", "our"), you agree to be bound by these Terms of Service and all policies incorporated by reference. If you do not agree, please do not use the Service.

This Service is available to users aged **18 and over**. Public profiles may be viewed worldwide.

---

## 2. What JA Profile Studio Is

JA Profile Studio is a digital business card and professional profile platform operated by JA Group Services Ltd. It allows users to:
...
8.3 Payment for business card orders is collected via a Stripe payment link or invoice issued by JA Profile Studio admin. Do not pay via any link that has not been issued through this official process.
...
9.2 "JA Profile Studio" and "JA Group Services" are trading names of JA Group Services Ltd. You may not use them without our written consent.
...
JA Group Services Ltd ("we", "us", "our") is committed to protecting your personal data. This Privacy Policy explains how we collect, use, store, and protect your information when you use JA Profile Studio ("the Service"). It also sets out your rights under UK GDPR and how to exercise them.

This policy complies with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018.

**Note on JA Group Services ID:** Authentication for JA Profile Studio is handled by JA Group Services ID, the identity and access management system operated by JA Group Services Ltd. Your use of JA Group Services ID is additionally governed by the JA Group Services website privacy policy and terms at jagroupservices.co.uk. This policy covers data processed by JA Profile Studio specifically.
...
This Acceptable Use Policy ("AUP") sets out the rules governing the use of JA Profile Studio ("the Service"), operated by JA Group Services Ltd. By using the Service, you agree to comply with this policy. This AUP is incorporated into our Terms of Service.
...
This Refund Policy applies to all paid subscriptions and services offered by JA Group Services Ltd through JA Profile Studio. By purchasing a subscription or service, you agree to the terms of this policy.
...
3.2 Payment is collected via a Stripe payment link or invoice issued by JA Profile Studio admin after your order details have been confirmed. Do not pay via any link that has not been issued through this official process.
...
JA Group Services Ltd is committed to providing a high-quality service. If something goes wrong or you are dissatisfied with any aspect of JA Profile Studio, we want to hear from you so we can put it right.
...
JA Group Services Ltd is committed to making JA Profile Studio accessible to as many people as possible. We aim to meet the **Web Content Accessibility Guidelines (WCAG) 2.1 Level AA** standard across all pages of the Service.
...
JA Profile Studio is built using React, TypeScript, and standard HTML5 with semantic markup. We test accessibility using:
...
If you experience any accessibility barriers when using JA Profile Studio, please contact us:
...
JA Profile Studio is available to users aged **18 and over only**. By registering for an account, you confirm that you are at least 18 years of age.
...
JA Profile Studio is operated by JA Group Services Ltd, a company registered in England and Wales. The Service is primarily intended for **UK-based users**.
...
JA Group Services Ltd operates JA Profile Studio ("the Service"). This policy explains how we handle reports of harmful, illegal, or policy-violating content on public profiles, and how we moderate the platform.
...
JA Group Services Ltd takes the security of JA Profile Studio and your personal data seriously. This Security Policy describes our approach to protecting the Service and its users. It is written for public transparency — it does not disclose implementation details that could create security risks.
...
This policy explains how long JA Group Services Ltd retains personal data collected through JA Profile Studio, and when that data is deleted. It should be read alongside our Privacy Policy.
