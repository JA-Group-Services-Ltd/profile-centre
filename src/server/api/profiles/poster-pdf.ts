 ...
 *
 * Wordmark ("Created with Sousa Murray Profiles") appears on free/starter plans.
...
async function t1Portrait(pdfDoc: PDFDocument, page: PDFPage, d: PosterData, fb: Font, fr: Font) {
  ...
  // Wordmark footer
  if (d.showWordmark) {
    const wm = 'Created with Sousa Murray Profiles · japrofilestudio.jagroupservices.co.uk';
...
async function t1Landscape(pdfDoc: PDFDocument, page: PDFPage, d: PosterData, fb: Font, fr: Font) {
  ...
  // Wordmark
  if (d.showWordmark) {
    const wm = 'Created with Sousa Murray Profiles';
...
async function t4Portrait(pdfDoc: PDFDocument, page: PDFPage, d: PosterData, fb: Font, fr: Font) {
  ...
  // Sousa Murray Profiles wordmark in header (always shown — this is the platform header, not the footer wordmark)
  txt(page, 'Sousa Murray Profiles', PAD, h - 30, 11, fb, hex('#bfdbfe'));
...
async function t4Landscape(pdfDoc: PDFDocument, page: PDFPage, d: PosterData, fb: Font, fr: Font) {
  ...
  txt(page, 'Sousa Murray Profiles', 16, h - 28, 10, fb, hex('#bfdbfe'), panelW - 32);
