...
const ALL_STEPS: Step[] = [
  ...
  },
  {
    ...
    detail: `Your QR code links directly to your profile. Anyone who scans it with their phone camera is taken straight to your JA Profile Studio.\n\nDownload a high-resolution PNG or SVG for use on business cards, posters, email footers, or anywhere else.`,
  ...
  },
  {
    ...
    description: 'A professional signature that links to your JA Profile Studio.',
    detail: `Your email signature includes your name, title, contact details, and a link (or QR code) to your JA Profile Studio.\n\nCopy the generated HTML and paste it into your email client — Gmail, Outlook, Apple Mail, and more are all supported.`,
