            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  <strong>{r.admin_name || r.admin_email || 'A Sousa Murray Profiles admin'}</strong> is currently viewing your account.
                </p>
          ...
          <div key={r.id} className="rounded-2xl bg-blue-500/10 border border-blue-500/30 p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  <strong>{r.admin_name || r.admin_email || 'A Sousa Murray Profiles admin'}</strong> has requested temporary access to your account.
                </p>
