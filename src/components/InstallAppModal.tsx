    ...
    <div className="space-y-4">
      <div>
        ...
        <ol className="space-y-3">
          <Step n={1}>
            Open <strong className="text-foreground">Profile Centre</strong> in <strong className="text-foreground">Safari</strong> on your iPhone or iPad.
          </Step>
          <Step n={2}>
          ...
          <Step n={4}>
            Edit the name if you like — we suggest <strong className="text-foreground">Profile Centre</strong>.
          </Step>
          <Step n={5}>
        ...
        <Tip>
          The app icon will appear on your home screen. Tap it to open Profile Centre in full-screen mode — no browser bar, just the app.
        </Tip>
        <Note>
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <ol className="space-y-3">
          <Step n={1}>Open <strong className="text-foreground">Profile Centre</strong> in <strong className="text-foreground">Chrome</strong> on your Android device.</Step>
          <Step n={2}>A banner may appear at the bottom saying <strong className="text-foreground">"Add Profile Centre to Home screen"</strong> — tap <strong className="text-foreground">"Add"</strong>.</Step>
      ...
      <div className="border-t border-border pt-4">
        ...
        <ol className="space-y-3">
          <Step n={1}>Open <strong className="text-foreground">Profile Centre</strong> in <strong className="text-foreground">Samsung Internet</strong>.</Step>
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <ol className="space-y-3">
          <Step n={1}>Open <strong className="text-foreground">Profile Centre</strong> in <strong className="text-foreground">Google Chrome</strong>.</Step>
      ...
      <div className="border-t border-border pt-4">
        ...
        <ol className="space-y-3">
          <Step n={1}>Open <strong className="text-foreground">Profile Centre</strong> in <strong className="text-foreground">Microsoft Edge</strong>.</Step>
      ...
      <Tip>
        Once installed, Profile Centre opens in its own window. Find it in your Start Menu (Windows) or Applications folder (Mac) like any other app.
      </Tip>
    </div>
  );
}
...
function DesktopSafariContent() {
  return (
    <div className="space-y-4">
      ...
      <ol className="space-y-3">
        <Step n={1}>Open <strong className="text-foreground">Profile Centre</strong> in <strong className="text-foreground">Safari</strong> on your Mac.</Step>
      ...
      <Tip>
        Profile Centre will appear in your Dock and can be launched like any other Mac app.
      </Tip>
      <Note>
...
export default function InstallAppModal() {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Install Profile Centre"
    >
      {/* Backdrop */}
      <div
      ...
      <div className="relative w-full sm:max-w-lg bg-card border border-border rounded-t-2xl sm:rounded-2xl shadow-2xl shadow-black/40 flex flex-col max-h-[92dvh] sm:max-h-[85vh] overflow-hidden">
        ...
        <div className="flex items-start gap-3 px-5 pt-5 pb-4 flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-base font-bold text-foreground leading-snug">Install Profile Centre</h2>
        ...
        {isStandalone && (
          <div className="mx-5 mb-4 p-3 rounded-lg bg-green-500/10 border border-green-500/20 flex items-center gap-2 flex-shrink-0">
            ...
            <p className="text-xs text-green-600 dark:text-green-400 font-medium">You're already running Profile Centre as an installed app.</p>
          </div>
        )}
