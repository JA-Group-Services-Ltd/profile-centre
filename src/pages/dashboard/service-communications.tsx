 ...
 * Shows official messages from JA Profile Studio / JA Group Services to the user.
  ...
  return (
    <div className="max-w-2xl mx-auto pb-20 lg:pb-0">
      <Helmet>
        ...
        <meta name="description" content="Official messages and updates from JA Profile Studio." />
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Official messages from JA Profile Studio and JA Group Services
          </p>
        </div>
      ...
      <div className="mb-5 p-3.5 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
            JA Profile Studio will never ask for your password, payment card details, or sensitive login information through this notification centre.
