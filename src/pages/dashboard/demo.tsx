...
export default function DemoPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto pb-16">
      <Helmet>
        <title>Demo Mode — Sousa Murray Profiles</title>
        <meta name="description" content="Explore Sousa Murray Profiles features in a safe sandbox without affecting your live data." />
