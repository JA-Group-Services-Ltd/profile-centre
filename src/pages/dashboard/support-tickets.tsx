...
export default function DashboardSupportTickets() {
  ...
  if (activeId) {
    return (
      <>
        <Helmet>
          <title>Support Ticket — Sousa Murray Profiles</title>
  ...
  if (showNewForm) {
    return (
      <>
        <Helmet>
          <title>New Support Request — Sousa Murray Profiles</title>
          <meta name="robots" content="noindex, nofollow" />
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        <title>My Support Tickets — Sousa Murray Profiles</title>
