...
export default function OverviewPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto pb-24 lg:pb-8 space-y-5">
      <Helmet>
        <title>Dashboard — Sousa Murray Profiles</title>
        <meta name="description" content="Your Sousa Murray Profiles dashboard." />
        ...
        <div className="space-y-5">
          ...
          {activeProfile && (
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">Share your Sousa Murray Profiles link with clients, colleagues and contacts.</p>
              <div className="flex gap-2">
