...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        body: `The Point of Sale (POS) feature is an admin-only tool used by the JA Profile Studio team to create secure Stripe Checkout payment links for custom amounts — for example, Business Card orders, custom invoices, or service fees.\n\n**As a customer, you do not need to use POS yourself.** When a payment is required (e.g. for a Business Card order), the admin team will send you an official Stripe invoice or Stripe payment link directly.\n\n**Only pay using an official Stripe invoice or Stripe payment link issued by JA Profile Studio / JA Group Services Ltd.** We will never ask for payment by bank transfer, cash, PayPal, or any other method.\n\nIf you have a question about a payment you have been asked to make, raise a support ticket or contact the team directly.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Request professionally printed business cards connected to your JA Profile Studio',
  ...
  },
  {
    ...
    description: 'Raise and track support requests with the JA Profile Studio team',
    color: 'text-violet-400 bg-violet-500/10 border-violet-500/20',
    articles: [
      {
        id: 'st-1',
...
export default function HelpCentre() {
  ...
  return (
    <div className="max-w-3xl mx-auto pb-20 lg:pb-0">
      <Helmet>
        <title>Help Centre — JA Profile Studio</title>
        <meta name="description" content="Find answers to your questions about JA Profile Studio." />
