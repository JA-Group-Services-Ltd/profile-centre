 ...
 *
 * A fully public, no-login-required showcase of the JA Profile Studio platform.
...
export default function PublicDemoPage() {
  ...
  return (
    <>
      <Helmet>
        <title>See How It Works — JA Profile Studio Demo</title>
        <meta name="description" content="Explore JA Profile Studio — personal and business digital profiles, QR codes, email signatures, and analytics. No login required." />
        <link rel="canonical" href="https://japrofilestudio.jagroupservices.co.uk/demo" />
        <meta property="og:title" content="See How It Works — JA Profile Studio Demo" />
        <meta property="og:description" content="Explore JA Profile Studio — personal and business digital profiles, QR codes, email signatures, and analytics." />
      ...
      <main className="min-h-screen bg-background">
          ...
          <div className="max-w-5xl mx-auto px-5 py-16 md:py-24 text-center relative">
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-5 leading-tight">
                See what JA Profile Studio<br className="hidden md:block" /> can do for you
              </h1>
        ...
        {/* ── Why JA Profile Studio ── */}
        <section className="border-t border-border bg-muted/20">
          <div className="max-w-5xl mx-auto px-5 py-16">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3">Why people choose JA Profile Studio</h2>
            </div>
        ...
        <section className="border-t border-border bg-muted/20">
          <div className="max-w-3xl mx-auto px-5 py-16 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-md mx-auto leading-relaxed">
              Join thousands of professionals and businesses already using JA Profile Studio. Free to start — no credit card needed.
            </p>
            <div className="flex flex-wrap gap-3 justify-center">
              <Link to="/login">
