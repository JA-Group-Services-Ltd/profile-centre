  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Services offered by JA Profile Studio, operated by JA Group Services Ltd. Digital profiles, QR codes, links and more." />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed max-w-2xl">
            JA Group Services Ltd operates JA Profile Studio — a digital profile service for professionals and businesses.
          </p>
        </div>
          ...
          >
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <h2 className="font-bold text-foreground group-hover:text-primary transition-colors">JA Profile Studio</h2>
