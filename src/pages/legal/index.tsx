...
const legalDocs = [
  { to: '/legal/terms',          icon: FileText,       title: 'Terms of Service',              desc: 'The terms and conditions governing your use of JA Profile Studio.' },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Legal documents for JA Profile Studio, operated by JA Group Services Ltd. Terms, Privacy Policy, Cookie Policy, Refund Policy and more." />
        <link rel="canonical" href={`${APP_URL}/legal`} />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content={`Legal — ${branding.platform_name}`} />
        <meta property="og:description" content="Legal documents for JA Profile Studio." />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed max-w-2xl">
            The following documents govern your use of JA Profile Studio, operated by JA Group Services Ltd. This service is available to UK-based users aged 18 and over only.
          </p>
        </div>
        ...
        <div className="mt-6 p-5 rounded-2xl border border-border bg-card flex items-start gap-4 hover:border-primary/40 hover:bg-muted/30 transition-all duration-200">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">Live operational status of all JA Profile Studio services.</p>
          </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
            JA Profile Studio is operated by JA Group Services Ltd. The following corporate policies also apply to your use of this service and JA Group Services ID.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              },
              {
                ...
                desc: 'Terms governing the use of JA Group Services ID, the single sign-on identity service used to access JA Profile Studio.',
              },
              {
        ...
        <div className="mt-8 p-5 rounded-2xl bg-muted/40 border border-border text-sm text-muted-foreground">
          <p>
            JA Profile Studio is a service operated by <strong className="text-foreground">JA Group Services Ltd</strong>, a company registered in England and Wales.
