  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Accessibility Statement for Sousa Murray Profiles. Our commitment to making this platform accessible to all users." />
      ...
      <DynamicLegalPage
        ...
        metaDescription="Accessibility Statement for Sousa Murray Profiles. Our commitment to making this platform accessible to all users."
      />
    </>
  );
}
