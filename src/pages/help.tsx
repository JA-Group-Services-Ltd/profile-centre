 ...
 * Covers common questions about Sousa Murray Profiles.
 */
...
const CATEGORIES: Category[] = [
  {
    ...
    articles: [
      { id: 'gs-1', title: 'How do I create an account?', tags: ['account', 'signup', 'login'],
        body: 'Your Sousa Murray Profiles account is created when you sign in for the first time using your Microsoft account. Click "Log In" on the homepage and authenticate with Microsoft. Your account is created automatically — no separate registration is needed.\n\nIf you have trouble signing in, make sure you are using the correct Microsoft account.' },
      { id: 'gs-2', title: 'What is Sousa Murray Profiles?', tags: ['overview', 'about'],
        body: 'Sousa Murray Profiles is a digital profile service that lets you keep your contact details, business information, links and QR code in one place. You can share your profile using a link, QR code, email signature, or printed materials.\n\nYour profile has a unique public URL that you can share with anyone.' },
  ...
  },
  {
    ...
    articles: [
      ...
      { id: 'b-4', title: 'How do I pay for Business Cards?', tags: ['business cards', 'payment', 'invoice'],
        body: 'Printed Business Cards are available to order through your dashboard. When you request business cards, an admin will confirm the price and create a Stripe invoice or Stripe payment link. Only pay using an official Stripe invoice or payment link from Sousa Murray Profiles / JA Group Services Ltd.\n\nDo not pay via any other method unless confirmed in writing by JA Group Services Ltd.' },
    ],
  },
  {
    id: 'privacy',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Help Centre for Sousa Murray Profiles. Find answers to common questions about your account, profiles, billing, privacy and more." />
        <link rel="canonical" href={`${APP_URL}/help`} />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content={`Help Centre — ${branding.platform_name}`} />
        <meta property="og:description" content="Find answers to common questions about Sousa Murray Profiles." />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Find answers to common questions about Sousa Murray Profiles. No login required.
          </p>
        </div>
