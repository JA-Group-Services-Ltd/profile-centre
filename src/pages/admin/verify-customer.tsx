          ...
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-3 text-xs text-muted-foreground">
              <div className="flex gap-2.5">
                ...
                <p>Ask the caller to open their Sousa Murray Profiles dashboard and go to <strong className="text-foreground">Security Settings</strong> for their Support PIN.</p>
              </div>
              <div className="flex gap-2.5">
